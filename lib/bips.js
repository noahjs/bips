...
function Bips(password, opts) {
    ...
    this.base_url = opts.base_url || 'https://bips.me/api/v1/';
...
Bips.prototype.getInvoiceKey = function() {
    this._raiseErr('Invoice');
    return this._keys['Invoice'].key;
};

Bips.prototype.getSendToKey = function() {
    this._raiseErr('SendTo');
    return this._keys['SendTo'].key;
};

Bips.prototype.getGetBalanceKey = function() {
    this._raiseErr('GetBalance');
    return this._keys['GetBalance'].key;
};
